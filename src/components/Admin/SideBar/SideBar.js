    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/AdminHome")}}>
            ...
            <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/AdminHome/users/new")}}>
              <ListItemButton
                sx={{
                  minHeight: 70,
                  justifyContent: open ? 'initial' : 'center',
            ...
            <ListItem  disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/AdminHome/AllEvents")}}>
              <ListItemButton
                sx={{
                  minHeight: 70,
                  justifyContent: open ? 'initial' : 'center',
